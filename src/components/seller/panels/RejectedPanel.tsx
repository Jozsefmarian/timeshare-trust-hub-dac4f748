      ...
      <CardContent>
        <div className="p-4 rounded-xl bg-destructive/5 border border-destructive/20 space-y-2">
          ...
          <p className="text-sm font-medium text-foreground">
            Az Ön által feltöltött dokumentumok alapján a szálláshely tiltja az átruházást, így sajnos
            nem tudjuk megvásárolni az üdülési jogát. A részletekért kérjük keresse fel
