  ...
  public: {
    Tables: {
      ...
      contract_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "contract_templates_created_by_user_id_fkey"
      ...
      signed_contract_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "signed_contract_files_case_id_fkey"
            columns: ["case_id"]
            isOneToOne: false
            referencedRelation: "cases"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "signed_contract_files_uploaded_by_fkey"
            columns: ["uploaded_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
