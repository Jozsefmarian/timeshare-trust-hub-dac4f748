      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="glass rounded-xl p-5">
            ...
            <p className="text-sm text-muted-foreground mb-4">We'll send a secure link to your email — no password needed.</p>
          ...
          <p className="text-sm text-muted-foreground text-center mt-8">
            Don't have an account? <a href="#" className="text-secondary font-medium hover:underline">Contact us to get started</a>
          </p>
        </div>
      </div>
    </div>
